...
For this deliverable I stored all user posts from the post page in the database, and wrote code to retrieve all posts from the database as well.
...
Endpoints for data - My stubbed out endpoints now process user post data and send it to Mongo. I also made endpoints to load the posts from the database.
...
WebSocket data displayed - All user chats are supposed to display in realtime. But when I started working on React, my chat broke and I could not figure out what was wrong for the life of me. It was working before, I dont know what happened there. My code for the chat is there in community_page.jsx. It worked a few deliverables ago, but decided to die at the last second ;-; have mercy.
## React Deliverable
