...
setInterval(() => {
    ...
    <br/><br/>
            ...
            <label for="sale-colors"><b>Color(s) (Optional)</b></label>
            <input id="sale-colors" type="text" placeholder="Enter Product Colors" name="sale-colors"/>
        
            <label for="sale-dimensions"><b>Dimensions (Optional)</b></label>
